...
export { countActiveIngestionJobs, reapStaleIngestionJobs } from './pg';
 ...
 */
export function getJobStore(db: Database, staleMinutes?: number): JobStore {
  return new PgJobStore(db, staleMinutes);
}
