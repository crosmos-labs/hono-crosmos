...
indexes are valid. A post-repair scheduled-run check remains before this schema
gate is closed. The operator opened the controlled security-endpoint trace
